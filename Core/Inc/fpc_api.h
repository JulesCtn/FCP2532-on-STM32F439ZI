/*
 * Copyright (c) 2024-2025 Fingerprint Cards AB
 *
 ...
 *
 *  Note: For versions 2024.3.0.026 (FPC2532) and
 *  2024.4.0.029 (FPC2534), ID:s above 9999 do not work.
 */
typedef struct {
...
typedef struct {
    /** Command header */
    fpc_cmd_hdr_t cmd;
    /** Result of sensor test. 0 = No error */
    uint16_t sensor_test_result;
    /** Overall verdict of the Builtin Self Test. 0 = FAIL, 1 = PASS */
